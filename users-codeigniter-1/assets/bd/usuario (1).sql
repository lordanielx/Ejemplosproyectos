...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2018 a las 05:56:51
...
(31, 'estoy muy cansado', 'de estudiar', 'elzurdo2018@htomail.com', '9999', '', '2018-12-03 03:34:50');
...
--
ALTER TABLE `usuario`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'identificador de la tabla', AUTO_INCREMENT=32;
COMMIT;
